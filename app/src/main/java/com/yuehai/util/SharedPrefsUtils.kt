...
import com.yuehai.data.Constants
...
object SharedPrefsUtils {
    private var sp: SharedPreferences = MyApplication.mContext.getSharedPreferences(Constants.SHARED_PREFERENCES, Context.MODE_PRIVATE)
